...
export const AI_MODELS: AiModel[] = [
  ...
  { id: "gpt-5-mini", provider: "OpenAI", modelKey: "gpt-5-mini" },
  { id: "gpt-4-1", provider: "OpenAI", modelKey: "gpt-4.1" },
  { id: "gpt-4o", provider: "OpenAI", modelKey: "gpt-4o" },
  { id: "gpt-4o-mini", provider: "OpenAI", modelKey: "gpt-4o-mini" },
  { id: "gpt-4-turbo", provider: "OpenAI", modelKey: "gpt-4-turbo" },
  { id: "o4", provider: "OpenAI", modelKey: "o4" },
  { id: "o4-mini", provider: "OpenAI", modelKey: "o4-mini" },
  ...
  { id: "gemini-2-5-flash", provider: "Google", modelKey: "gemini-2.5-flash" },
  { id: "gemini-2-0-flash", provider: "Google", modelKey: "gemini-2.0-flash" },
  { id: "gemini-1-5-pro", provider: "Google", modelKey: "gemini-1.5-pro" },
  { id: "grok-4-6", provider: "xAI", modelKey: "grok-4.6" },
  { id: "grok-4-5", provider: "xAI", modelKey: "grok-4.5" },
  { id: "grok-4-3", provider: "xAI", modelKey: "grok-4.3" },
  { id: "grok-4-1-fast", provider: "xAI", modelKey: "grok-4.1-fast" },
  { id: "grok-4-1", provider: "xAI", modelKey: "grok-4.1" },
  { id: "grok-4", provider: "xAI", modelKey: "grok-4" },
  { id: "grok-3", provider: "xAI", modelKey: "grok-3" },
  { id: "grok-3-mini", provider: "xAI", modelKey: "grok-3-mini" },
  { id: "grok-code-fast-1", provider: "xAI", modelKey: "grok-code-fast-1" },
  { id: "grok-build-0-1", provider: "xAI", modelKey: "grok-build-0.1" },
  { id: "grok-2-vision", provider: "xAI", modelKey: "grok-2-vision-1212" },
  { id: "grok-2", provider: "xAI", modelKey: "grok-2-1212" },
  ...
  { id: "llama-4", provider: "Meta", modelKey: "llama-4" },
  ...
  { id: "mistral-small", provider: "Mistral", modelKey: "mistral-small-latest" },
  { id: "ministral-8b", provider: "Mistral", modelKey: "ministral-8b-latest" },
  { id: "codestral", provider: "Mistral", modelKey: "codestral-latest" },
  { id: "pixtral-large", provider: "Mistral", modelKey: "pixtral-large-latest" },
  { id: "qwen-3", provider: "Alibaba", modelKey: "qwen-3" },
  ...
  { id: "nova-premier", provider: "Amazon", modelKey: "nova-premier" },
  { id: "nova-pro", provider: "Amazon", modelKey: "nova-pro" },
  { id: "nova-lite", provider: "Amazon", modelKey: "nova-lite" },
